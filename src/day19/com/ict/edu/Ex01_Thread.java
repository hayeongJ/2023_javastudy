...
// 싱글 스레드 : 하나의 프로세스에서 하나의 스레드가 일처리 하는 것(day01 ~ day18)
// 자바에서 스레드 생성법
// *** 자바에서는 start()를 호출하여 run()가 실행되면 스레드 처리 됐다고 함 ***
// 1. Thread 클래스 상속 받기 : start(), run() 메소드가 모두 있다.
// 2. Runnale 인터페이스 구현 : run()만 존재
...
public class Ex01_Thread {
	...
	public static void main(String[] args) {
		...
		// main 메소드에서 일하는 스레드를 main 스레드라고 한다.
