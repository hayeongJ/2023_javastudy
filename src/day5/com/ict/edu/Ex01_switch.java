...
public class Ex01_switch {
	public static void main(String[] args) {
		/* Switch ~ case : 다중 if ~ else문과 같은 조건문
		  ...
		  Switch문은 int, char, String 일 때 사용 (long, float, double 형은 X)
		  형식) switch (인자값 = int, char, String){
		  		case 조건값1 : 인자값과 조건값1이 같을 때 수행할 문장 ; break;
		  		case 조건값2 : 인자값과 조건값2이 같을 때 수행할 문장 ; 
		  					인자값과 조건값2이 같을 때 수행할 문장 ; break; >> 문장의 끝에만 break 주면 된다.
		  		case 조건값3 : 인자값과 조건값3이 같을 때 수행할 문장 ; break;
		  		default : 조건값1, 2, 3 모두 같지 않을 때 (나머지) 수행할 문장; break; >> break 유무는 자유.
		...
		// char k3이 A, a이면 아프리카, B, b이면 브라질, C, c 이면 캐나다, 나머지는 한국
		
		char k3 = 'a';
		switch (k3) {
			case 'A': res ="아프리카"; break;
			case 'a': res ="아프리카"; break; // 비교연산을 못써서 하나씩 기입해줘야한다.
		...
		*/
		...
		System.out.println("계절은 " + res + "입니다");
		System.out.println("==========================");
		...
		*/
		...
		System.out.println("학점은 " + res + "입니다");
		System.out.println("==========================");
